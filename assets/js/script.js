...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const courses = {
    1: {
      ...
      startDate: "May 2024",
      description:
        "This course is designed for beginners to learn how to build responsive and interactive websites using HTML and CSS. You will acquire fundamental skills in web development and design.",
      details: [
      ...
      weeks: [
        {
          ...
          description:
            "Welcome to the course! In this first week, you'll learn the basics of HTML and CSS for building responsive websites.",
        ...
        },
        {
          ...
          description:
            "Discover how to create responsive layouts and design principles for various screen sizes.",
    ...
    2: {
      ...
      description:
        "This advanced course is tailored for software developers looking to master Java programming concepts and techniques.",
      details: [
      ...
      weeks: [
        {
          ...
          description:
            "Introduction to Java programming language fundamentals and syntax.",
    ...
    3: {
      ...
      description:
        "Learn how to create professional-quality videos and screen recordings using Camtasia.",
      details: [
      ...
      weeks: [
        {
          ...
          description:
            "Getting started with Camtasia and understanding its features.",
        ...
        },
        {
          ...
          description:
            "Learn advanced video editing techniques using Camtasia.",
          topics: [
    ...
    4: {
      ...
      description:
        "Explore Python programming for data analysis, machine learning, and artificial intelligence applications.",
      details: [
      ...
      weeks: [
        ...
        },
        {
          ...
          description:
            "Using Pandas library for data manipulation and analysis.",
    ...
    5: {
      ...
      description:
        "Learn essential concepts and strategies for digital marketing and online advertising.",
      details: [
      ...
      weeks: [
        {
          ...
          description:
            "Understanding digital marketing landscape and key concepts.",
        ...
        },
        {
          ...
          description:
            "Using social media platforms for marketing and engagement.",
    ...
    6: {
      ...
      description:
        "Get started with machine learning algorithms and applications.",
      details: [
  ...
  const displayCourseDetails = (courseId) => {
    ...
    document.getElementById(
      "start-date"
    ).innerHTML = `<option value="${course.startDate}">${course.startDate}</option>`;
    ...
    const admissionRequirementsList = document.getElementById(
      "admissionRequirements"
    );
    ...
    document.getElementById("admissionsContact").textContent =
      course.admissionsContact;
    document.getElementById("academicSchool").textContent =
      course.academicSchool;
